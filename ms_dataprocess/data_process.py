...
class ComfortCalculator:
    ...
    def __init__(self, df_raw, df_raw_long, kit_id=0):
    ...
    def adaptive_comfort_model(self, eu_norm='16798-1:2019', alpha=0.8,
        ...
        if self.graph:
            ...
            plt.savefig(f"/home/io3/Desktop/codice_bk_2023_06_18/ms_cloud/adaptive_{self.id}.png", transparent=False)
            plt.close(fig)
            """
